...
def ground_LAS(ground_file_name):
	...
	cand = [i for i in range(len(point_3d)) if ((classess[i]==2 and ((point_3d[i,4]<0.39*point_3d[i,3]+0.61*point_3d[i,5]) and ((.85*point_3d[i,4]<point_3d[i,3]) and (.7*point_3d[i,4]<point_3d[i,5])))))]
